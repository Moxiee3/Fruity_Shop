...
import 'package:fruit_shop/model/fruit_model.dart';
import 'package:fruit_shop/view/product_detail.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_grid_view.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_tile.dart';

class FruitShopHomeScreen extends StatefulWidget {
  const FruitShopHomeScreen({super.key});

  @override
  State<FruitShopHomeScreen> createState() => _FruitShopHomeScreenState();
}

class _FruitShopHomeScreenState extends State<FruitShopHomeScreen> {
  int selectedIndex = 0;
  @override
